...
#define semtimedop vns_semtimedop
#define semtimedop_time32 vns_semtimedop_time32
#define semop vns_semop
#define ksys_semget vns_ksys_semget
#define ksys_old_semctl vns_ksys_old_semctl
#define compat_ksys_old_semctl vns_compat_ksys_old_semctl
#define __do_semtimedop vns___do_semtimedop
#define ksys_semtimedop vns_ksys_semtimedop
