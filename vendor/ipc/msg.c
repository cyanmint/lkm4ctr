 ...
 * sysvipc_msg_proc_show()'s seq_user_ns() (<linux/seq_file.h>, used below)
...
#define msgsnd vns_msgsnd
#define msgrcv vns_msgrcv
#define ksys_msgget vns_ksys_msgget
#define ksys_old_msgctl vns_ksys_old_msgctl
#define compat_ksys_old_msgctl vns_compat_ksys_old_msgctl
#define ksys_msgsnd vns_ksys_msgsnd
#define compat_ksys_msgsnd vns_compat_ksys_msgsnd
