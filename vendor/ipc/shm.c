 ...
 * shm_show()'s seq_user_ns() (<linux/seq_file.h>, used below) and
 * from_kuid_munged()/from_kgid_munged() (<linux/uidgid.h>) have static
 ...
 * (do_mmap()/vfs_mmap() argument changes); see glue/lkm4ctr_compat.h. */
...
#define shmat vns_shmat_syscall
#define shmdt vns_shmdt
#define ksys_shmget vns_ksys_shmget
#define ksys_old_shmctl vns_ksys_old_shmctl
#define compat_ksys_old_shmctl vns_compat_ksys_old_shmctl
