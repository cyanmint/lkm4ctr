 ...
 * [5.10, 5.15) VFS API era (legacy mount(get_sb)-style
 ...
 * Verified identical between android12-5.10 and android13-5.10.
 ...
 * (see glue/vendor_kernel_ovl_vfs_compat_5_10.h) -- its entire body is
...
#endif /* LINUX_VERSION_CODE in [KERNEL_VERSION(5, 10, 0), KERNEL_VERSION(5, 15, 0)) */
