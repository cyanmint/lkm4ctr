 ...
 * module-owned - see vendor/README.md, "Slab-cache consistency with the
...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(6, 3, 0)
/*
 * [BUILD-COMPAT] glue/lkm4ctr_compat.h's lkm4ctr_lookup_one_len() calls the
