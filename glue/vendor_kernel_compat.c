...
#include "../vendor/include/uapi/vendor_kernel.h"
 ...
 * contained, module-owned frees). See vendor/README.md, "Slab-cache
...
#define RESOLVE_EXPECTED(var, sym) \
	 ...
	 * vns_pid_ns_init()/vns_user_ns_init()); see vendor/README.md,
 ...
 * its own net namespaces (see vendor/kernel/nsproxy.c, which only
